...
function UpperUI({setNewLinkVis, setNewBookmarkVis, setBookmarkType}: Props): JSX.Element{

  // const [newLinkVis, setNewLinkVis] = useState<boolean>(false);

    return (
        <div className="h-32 relative mx-4">
            <UpperRightMenu setNewLinkVis={setNewLinkVis} setNewBookmarkVis={setNewBookmarkVis}  setBookmarkType={setBookmarkType}/>
